namespace Constant
{
	public static class ObjectName
	{
		...
		public const string c_PooledAudioSourcesParent = "Pooled audio sources";
		public const string c_DeathEffectAudioSource = "Death effect audio source";
		public const string c_AdditionalAudioSourceParent = "Additional audio sources";
	}
}